...
@interface ResetPasswordController ()<UITableViewDataSource,UITableViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell==nil) {
        ...
        [codeBtn jk_addActionHandler:^(NSInteger tag) {
            ...
            [DataSourceTool requestMobileCode:@"18353130882" typePhone:@"1" toViewController:self success:^(id json) {
    ...
    {
        UITextField *textFiled = [cell2.contentView viewWithTag:101];
        textFiled.text = password;
        return cell2;
    }
    else
    {
        UITextField *textFiled = [cell2.contentView viewWithTag:100];
        textFiled.text = code;
        return cell;
    }
}
...
- (void)confirm
{
    [DataSourceTool findPassword:self.mobile password:password code:code  toViewController:self success:^(id json) {
