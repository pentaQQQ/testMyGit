...
//    _textColor = colorWithRGB(0xffae00);
    
    _inputBgColor = colorWithRGB(0xffffff);
    _inputPlaceHolderTextColor = colorWithRGB(0xcccccc);
    _inputTextColor = colorWithRGB(0x000000);
    _inputBorderColor = colorWithRGB(0xfafafa);
    _bgColor = colorWithRGB(0xffffff);
    _textColor = colorWithRGB(0xffae00);
    _borderColor = colorWithRGB(0xffae00);
    _selBgColor = colorWithRGB(0xffae00);
    _selTextColor = colorWithRGB(0xffffff);
    _selBorderColor = colorWithRGB(0xffae00);
