...
{
    [self.videoControl.backButton addTarget:self action:@selector(backClick) forControlEvents:UIControlEventTouchUpInside];
    [self.videoControl.shareButton addTarget:self action:@selector(shareClick) forControlEvents:UIControlEventTouchUpInside];
    [self.videoControl.likeButton addTarget:self action:@selector(likeClick) forControlEvents:UIControlEventTouchUpInside];
...
{
    [self.videoControl.likeButton setHidden:NO];
    [self.videoControl.shareButton setHidden:NO];
    [self.videoControl.titleLabel setHidden:NO];
...
{
    [self.videoControl.likeButton setHidden:YES];
    [self.videoControl.shareButton setHidden:YES];
    [self.videoControl.titleLabel setHidden:YES];
    if (!self.isFullscreenMode) {
        return;
    }
...
{
    [self.videoControl.titleLabel setHidden:hidden];
    [self.videoControl.shareButton setHidden:hidden];
